...
from test.datasets.managers.puzzles_test import PuzzlesTest, PuzzlesResponse
from test.datasets.managers.restaurants_test import RestaurantsTest, RestaurantsResponse
