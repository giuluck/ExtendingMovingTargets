...
from src.restaurants.models import MTLearner, MTMaster, MT
from src.moving_targets.callbacks import FileLogger
...
class TestMTM(MTMaster):
    def __init__(self, monotonicities, alpha=1., beta=1., gamma=1., time_limit=30):
        super(TestMTM, self).__init__(monotonicities, alpha, beta, time_limit)
        self.gamma = gamma
