...
class TestCustomScalers(unittest.TestCase):
    ...
    def _test(self, filename: str, method: str):
        ...
        x, y = x.reset_index(drop=True), pd.Series(y, name='y')
        ...
        custom_scaler = Scaler(default_method=method, y='onehot')
        ...
        expected, actual = set(np.unique(y)), set(y_custom.columns)
